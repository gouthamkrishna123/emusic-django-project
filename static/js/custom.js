			...
			[
				{
					title:"kesariya",
					artist:"Arijit Singh",
					mp3:"static/files/Kesariya(PagalWorld.com.pe).mp3",
					duration:"2.33"
				},
				{
					title:"Kalapakkaara",
					artist:" Shreya Ghoshal, Jakes Bejoy, Fejo, Benny Dayal, Joe Paul",
					mp3:"static/files/King-of-KothaPaglaSongs.mp3",
					duration:"2.04"
				},
				{
					title:"Oru Rajamalli",
					artist:"M G Sreekumar",
					mp3:"static/files/Oru-Rajamalli-M.G-Sreekumar_FYznkOb.mp3",
					duration:"2.20"
				},
				{
					title:"Nee Singam Dhan",
					artist:"A. R. Rahman, Sid Sriram",
					mp3:"static/files/Nee_Singam_Dhan_Pathu_Thala_128_Kbps.mp3",
					duration:"2.33"
				},
				{
					title:"Naan ready",
					artist:"vijay",
					mp3:"static/files/Naan-ReadyPaglaSongs.mp3",
					duration:"2.04"
				},
				{
					title:"Aadharanjali",
					artist:"Bensound",
					mp3:"static/files/Aadharanjali.mp3",
					duration:"2.20"
				}
			];
	...
	function initSinglePlayer()
	{
		...
		ready: function () {
			$(this).jPlayer("setMedia", {
				title:"Kadhal Rojave",
					artist:"A. R. Rahman",
					mp3:"static/files/Kadhal-Rojave.mp3"
			});
		},
		play: function() { // To avoid multiple jPlayers playing together.
			$(this).jPlayer("pauseOthers");
